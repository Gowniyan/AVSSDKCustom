...
public:
    ...
    void tap();
     ...
     /**
     * Should be called whenever a user presses and releases the skill button.
     */
    void skill();
...
private:
    ...
    bool m_isMicOn;
     ...
     /// Whether a skill is currently occurring. Creating skill audio provider
    bool m_isSkillOccurring;
